...
%DIF ADD Grabovoy2020PL.tex         Sun Aug 22 10:52:20 2021
...
\year{2020}
\title{\DIFdelbegin \DIFdel{Анализ моделей привилегированного обучения и }\DIFdelend \DIFaddbegin \DIFadd{Вероятностная интерпретация задачи }\DIFaddend дистилляции}%
...
\bibitem{Vaswani2017}
	\textit{Vaswani A., \DIFdelbegin \DIFdel{Shazeer N}\DIFdelend \DIFaddbegin \DIFadd{Gomez A}\DIFaddend ., \DIFdelbegin \DIFdel{Parmar N., Uszkoreit J., }\DIFdelend Jones L., \DIFdelbegin \DIFdel{Gomez A., }\DIFdelend Kaiser L., \DIFaddbegin \DIFadd{Parmar N., }\DIFaddend Polosukhin I.\DIFaddbegin \DIFadd{, Shazeer N., Uszkoreit J.}\DIFaddend } Attention Is All You Need // In Advances in Neural Information Processing Systems. 2017. V.\DIFaddbegin \DIFadd{~}\DIFaddend 5. P.\DIFaddbegin \DIFadd{~}\DIFaddend 6000--6010.
\bibitem{Devlin2018}
   \textit{Devlin J., Chang M., Lee K., Toutanova K.} BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding // \DIFdelbegin \DIFdel{arXiv preprint arXiv: 1810.04805. 2018.
}\DIFdelend \DIFaddbegin \DIFadd{Proc. 2019 Conf. North }{\DIFadd{A}}\DIFadd{merican Chapter of the Association for Computational Linguistics: Human Language Technologies. Minnesota. 2019. V.~1. P.~4171--4186.
}\DIFaddend \bibitem{Kaiming2015}
	\textit{He K., \DIFdelbegin \DIFdel{Zhang X., }\DIFdelend Ren S., Sun J.\DIFaddbegin \DIFadd{, Zhang X.}\DIFaddend } Deep Residual Learning for Image Recognition // Proc. \DIFdelbegin \DIFdel{of the IEEE Conference }\DIFdelend \DIFaddbegin \DIFadd{IEEE Conf. }\DIFaddend on Computer Vision and Pattern Recognition. Las Vegas\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend 2016. P.\DIFaddbegin \DIFadd{~}\DIFaddend 770--778.
\bibitem{bachteev2018}
	\textit{Бахтеев О.\,Ю., Стрижов В.\,В.} Выбор моделей глубокого обучения субоптимальной сложности // АиТ. 2018. №\DIFaddbegin \DIFadd{~}\DIFaddend 8. С.\DIFaddbegin \DIFadd{~}\DIFaddend 129--147.
\bibitem{Hinton2015}
    \textit{Hinton G., \DIFdelbegin \DIFdel{Vinyals O., }\DIFdelend Dean J.\DIFaddbegin \DIFadd{, Vinyals O.}\DIFaddend } Distilling the Knowledge in a Neural Network // NIPS Deep Learning and Representation Learning Workshop. 2015.
\DIFaddbegin \bibitem{Bucilu2006}
    \textit{\DIFadd{Bucilu C., Caruana R., Mizil A.}} \DIFadd{Model compression // Proc. ACM SIGKDD Conf. on Knowledge Discovery and Data mining. Philadelphia. 2006. P.~535--541.
}\bibitem{Lopez2016}
	\textit{\DIFadd{Lopez-Paz D., Bottou L., Scholkopf B., Vapnik V.}} \DIFadd{Unifying Distillation and Privileged Information // Int. Conf. on Learning Representations. Puerto Rico. 2016.
}\bibitem{Tang2016}
    \textit{\DIFadd{Tang Z., Wang D., Zhang Z.}} \DIFadd{Recurrent neural network training with dark knowledge transfer // Proc. IEEE Conf. on Acoustics, Speech and Signal Processing. Shanghai. 2016. V.~2. P.~5900--5904.
}\bibitem{Tzeng2015}
    \textit{\DIFadd{Darrell T., Hoffman J., Saenko K., Tzeng E.}} \DIFadd{Simultaneous deep transfer across domains and tasks // Proc. IEEE Conf. on Computer Vision. Santiago. 2015. V.~2. P.~4068--4076.
}\bibitem{Ahn2019}
    \textit{\DIFadd{Ahn S., Dai Z., Damianou A., Hu S., Lawrence N.}} \DIFadd{Variational information distillation for knowledge transfer // Proc. IEEE Conf. on Computer Vision and Pattern Recognition. Long Beach. 2019. P.~9163--9171.
}\DIFaddend \bibitem{mnist}
	\textit{\DIFdelbegin \DIFdel{LeCun Y}\DIFdelend \DIFaddbegin \DIFadd{Burges C}\DIFaddend ., Cortes C.,  \DIFdelbegin \DIFdel{Burges C}\DIFdelend \DIFaddbegin \DIFadd{LeCun Y}\DIFaddend .} The MNIST dataset of handwritten digits\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend 1998. \text{http://yann.lecun.com/exdb/mnist/index.html}.
\DIFaddbegin \bibitem{Ziqing2020}
    \textit{\DIFadd{Che Z., Chen Y., Guoping H., Liu W., Wang T., Ziqing Y.}} \DIFadd{TextBrewer: An Open-Source Knowledge Distillation Toolkit for Natural Language Processing // Proc. 58th Annual Meeting of the Association for Computational Linguistics: System Demonstrations. Online. 2020.
}\bibitem{Zehao2017}
    ...
    \textit{\DIFadd{Fu T., Lei Z., Liao S., Mei T., Wang S., Wang X.}} \DIFadd{Exclusivity-Consistency Regularized Knowledge Distillation for Face Recognition // Lecture Notes in Computer Science. 2020. V.~1 P.~23--69.
}\DIFaddend \bibitem{Vapnik2015}
	\textit{Vapnik V., Izmailov R.} Learning Using Privileged Information: Similarity Control and Knowledge Transfer // \DIFdelbegin \DIFdel{Journal }\DIFdelend \DIFaddbegin \DIFadd{J. }\DIFaddend of Machine Learning Research. 2015. \DIFdelbegin \DIFdel{No }\DIFdelend \DIFaddbegin \DIFadd{V.~}\DIFaddend 16. P.\DIFaddbegin \DIFadd{~}\DIFaddend 2023--2049.
\DIFdelbegin %DIFDELCMD < \bibitem{Lopez2016}
%DIFDELCMD < 	%%%
\textit{\DIFdel{Lopez-Paz D., Bottou L., Scholkopf B., Vapnik V.}} %DIFAUXCMD
\DIFdel{Unifying Distillation and Privileged Information // In International Conference on Learning Representations. Puerto Rico, 2016.
}\DIFdelend \bibitem{Ivakhnenko1994}
	\textit{\DIFdelbegin \DIFdel{Madala H., }\DIFdelend Ivakhnenko A.\DIFaddbegin \DIFadd{, Madala H.}\DIFaddend } Inductive Learning Algorithms for Complex Systems Modeling. Boca Raton: CRC Press Inc. \DIFdelbegin \DIFdel{, }\DIFdelend 1994.
\bibitem{fashionmnist}
	\textit{\DIFdelbegin \DIFdel{Xiao H., }\DIFdelend Rasul K., Vollgraf R.\DIFaddbegin \DIFadd{, Xiao H.}\DIFaddend } Fashion-MNIST: a Novel Image Dataset for Benchmarking Machine Learning Algorithms // arXiv preprint arXiv:1708.07747. 2017.
\bibitem{twiter2013}
	\textit{\DIFdelbegin \DIFdel{Wilson T., }\DIFdelend Kozareva Z., Nakov P., \DIFaddbegin \DIFadd{Ritter A., }\DIFaddend Rosenthal S., Stoyanov V., \DIFdelbegin \DIFdel{Ritter A}\DIFdelend \DIFaddbegin \DIFadd{Wilson T}\DIFaddend .} {S}em{E}val-2013 Task 2: Sentiment Analysis in Twitter // \DIFdelbegin \DIFdel{Proceedings of the Seventh International }\DIFdelend \DIFaddbegin \DIFadd{Proc. Seventh Int. }\DIFaddend Workshop on Semantic Evaluation ({S}em{E}val 2013). Atlanta\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend 2013. P.\DIFaddbegin \DIFadd{~}\DIFaddend 312--320.
\bibitem{LeCun1989}
	\textit{\DIFdelbegin \DIFdel{LeCun Y., }\DIFdelend Boser B., Denker J., Henderson D., Howard R., Hubbard W., Jackel L.\DIFaddbegin \DIFadd{, LeCun Y.}\DIFaddend } Backpropagation Applied to Handwritten Zip Code Recognition // Neural Computation. 1989. V. 1. No 4. P. 541--551.
...
\bibitem{kingma2014}
	\textit{\DIFdelbegin \DIFdel{Kingma D, }\DIFdelend Ba J.\DIFaddbegin \DIFadd{, Kingma D}\DIFaddend } Adam: A Method for Stochastic Optimization // \DIFdelbegin \DIFdel{arXiv preprint arXiv:1412.6980}\DIFdelend \DIFaddbegin \DIFadd{Int. Conf. on Learning Representations. San Diego}\DIFaddend . 2014.
\bibitem{Code2020}
