...
(Московский физико-технический институт; Вычислительный центр им. А.А. Дородницына ФИЦ ИУ РАН, Москва)}
...
\end{aligned}
\end{gather}
а множество индексов объектов, для которых неизвестна привилегированная информация, обозначим $\bar{\mathcal{I}}=\{1, \ldots, m\}\setminus \mathcal{I}$.
...
Рассмотрим описание метода, предложенного в публикациях~\cite{Hinton2015, Lopez2016}, в которых предполагается, что для всех данных доступна привилегированная информация~$\mathcal{I} = \{1, 2, \ldots, m\}$. В~\cite{Hinton2015} решается задача классификации:
\begin{gather}
...
\begin{gather}
    \mathcal{D} = \left\{\left(\mathbf{x}_i, \mathbf{x}^*_i, y_i\right)\right\}_{i=1}^{m}, \qquad \mathbf{x}_i \in \mathbb{R}^{n}, \quad \mathbf{x}^*_i \in \mathbb{R}^{n^*}, \quad y_i \in \{1, \ldots, K\},
\end{gather}
...
\section{Заключение}
\begin{table}[]
\caption{{\bf Таблица.} Сводная таблица результатов вычислительного эксперимента}
\label{tb:ce:1}
\begin{center}
\resizebox{\textwidth}{!}{
...
\bibitem{Kaiming2015}
 ...
 \bibitem{bachteev2018}
 	...
 	\textit{Bakhteev O.Yu., Strijov V.V.} Deep Learning Model Selection of Suboptimal Complexity // Automat. Remote Control. 2018. V.~79. P.~1474--1488.
\bibitem{Hinton2015}
...
\centering
\caption*{~~~~\textit{а}}
\includegraphics[width=\textwidth]{figures/mnist_loss_1.png}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\caption*{~~~~\textit{б}}
\includegraphics[width=\textwidth]{figures/mnist_loss_2.png}
\end{subfigure}%
\caption{Рис. 3.}
...
\begin{figure}[h!]
\rotatebox[origin=c]{90}{\parbox{7em}{\centering\scriptsize Пятый объект~~~\\~}}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{а}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_0.png}
\end{subfigure}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{б}}
\includegraphics[width=0.96\textwidth]{figures/syn_T_lambda_1.png}
\end{subfigure}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{в}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_2.png}
\end{subfigure}\\
\rotatebox[origin=c]{90}{\parbox{7em}{\centering\scriptsize Девятый объект~~~\\~}}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{г}}
\includegraphics[width=0.96\textwidth]{figures/syn_T_lambda_3.png}
\end{subfigure}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{д}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_4.png}
\end{subfigure}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{е}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_5.png}
\end{subfigure}\\
\rotatebox[origin=c]{90}{\parbox{7em}{\centering\scriptsize ~~~~~~Семнадцатый\\~~~~~~объект}}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{ж}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_6.png}
\caption*{Первый Класс}
\end{subfigure}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{з}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_7.png}
\caption*{Второй Класс}
\end{subfigure}%
\begin{subfigure}{0.32\textwidth}
\caption*{\textit{и}}
\includegraphics[width=\textwidth]{figures/syn_T_lambda_8.png}
\caption*{Третий Класс}
\end{subfigure}%
\caption{Рис. 7.}
